...
class CryptoWallet:
    ...
    def generate_address(private_key):
        public_key = CryptoWallet.private_to_public(private_key)
        address = CryptoWallet.__public_to_address(public_key)
        return address
        
    @staticmethod
    def generate_compressed_address(private_key):
        public_key = CryptoWallet.__private_to_compressed_public(private_key)
        address = CryptoWallet.__public_to_address(public_key)
        return address
